...
module SingularApi
  ...
  class SbpProfile
    ...
    def hash
      [address, city, country, currency, cvv, email, expirymmyy, orderid, partnerid, partnerkey, payeefirstname, payeeid, payeelastname, paymentmode, profileid, routingnumber, state, tokenizedaccountnumber, udfield1, udfield2, udfield3, zip].hash
    end
