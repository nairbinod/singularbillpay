...
module SingularApi
  # Model for SbpRecurringRequest
  class SbpRecurringRequest
    attr_accessor :address

    attr_accessor :amountoutstanding
    ...
    attr_accessor :paymentenddate

    attr_accessor :paymentmode

    attr_accessor :paymentstartdate
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'amountoutstanding']
        self.amountoutstanding = attributes[:'amountoutstanding']
      end
      ...
      if attributes[:'nextpaymentdate']
        self.nextpaymentdate = attributes[:'nextpaymentdate']
      end
      ...
      if attributes[:'paymentenddate']
        self.paymentenddate = attributes[:'paymentenddate']
      end
      ...
      if attributes[:'paymentstartdate']
        self.paymentstartdate = attributes[:'paymentstartdate']
      end
      ...
      if attributes[:'recurringamount']
        self.recurringamount = attributes[:'recurringamount']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paymentenddate == o.paymentenddate &&
          paymentmode == o.paymentmode &&
          paymentstartdate == o.paymentstartdate &&
    ...
    def hash
      [address, amountoutstanding, city, country, currency, cvv, email, expirymmyy, frequency, nextpaymentdate, orderid, partnerid, partnerkey, payeefirstname, payeeid, payeelastname, paymentenddate, paymentmode, paymentstartdate, profileid, recurringamount, routingnumber, state, tokenizedaccountnumber, udfield1, udfield2, udfield3, zip].hash
    end
